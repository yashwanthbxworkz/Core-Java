class TouristCompanyRun{

	public static void main(String[] agrs){
	
	
boolean	place = TouristCompany.searchforPlace("Expedia");
place = TouristCompany.searchforPlace("Thomas Cook");
place = TouristCompany.searchforPlace("Airbnb ");
place = TouristCompany.searchforPlace("Priceline");
place = TouristCompany.searchforPlace(" Orbitz");
